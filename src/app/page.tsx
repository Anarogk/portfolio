...
export default function Page() {
  return (
    <>
      {/* Neko Script Start */}
      <div>
        <script dangerouslySetInnerHTML={{ __html: 'NekoType="white"' }} />{" "}
        <h1 id="nl">
              ...
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    I&apos;ve worked on a variety of software development
                    projects, including networking, web development, and Data
